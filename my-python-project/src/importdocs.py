...
textdocspath = "../resources"
text_data = readtextfiles(textdocspath)

collection = chromaclient.get_or_create_collection(name="buildcarrag", metadata={"hnsw:space": "cosine"}  )
if any(collection.name == collectionname for collection in chromaclient.list_collections()):
  chromaclient.delete_collection("buildcarrag")
